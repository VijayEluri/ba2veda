		...
		implements IXMLParser
{
	...
	/**
	 * The comment for XML element.
	 */
	public String comment = "";
	/**
	 * Determine whether to include comment for processing.
	 */
			...
			throws Exception
	{
		...
		switch (ch)
		{
			...
			case '-':
				comment = XMLUtil.skipComment(this.reader);
				if (!includeComment)
				{
					comment = null;
				}
			...
			throws Exception
	{
		...
		comment = null; // Clear for next tag run
