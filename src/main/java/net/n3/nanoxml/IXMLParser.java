...
public interface IXMLParser
{
	...
	/**
	 * Parses the data and lets the builder create the logical data structure excluding comment.
	 ...
	 * an XMLException.
	 *
	 * @param includeComment Determine whether to include comment for processing.
	 * @return the logical structure built by the builder.
	 * @throws net.n3.nanoxml.XMLException if an error occurred reading or parsing the data
	 * @see net.n3.nanoxml.IXMLBuilder#getResult
	 */
	public Object parse(boolean includeComment)
			throws XMLException;
}
