 ...
 * 
 */
@WebFault(name = "AccessDeniedException", targetNamespace = "http://search.bigarchive.magnetosoft.ru/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: ru.magnetosoft.bigarch.wsclient.bl.searchservice.AccessDeniedException
     */
