 ...
 * 
 */
@WebFault(name = "AccessDeniedException", targetNamespace = "http://attachments.bigarchive.magnetosoft.ru/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: ru.magnetosoft.bigarch.wsclient.bl.attachmentservice.AccessDeniedException
     */
