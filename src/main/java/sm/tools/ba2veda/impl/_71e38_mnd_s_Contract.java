...
public class _71e38_mnd_s_Contract extends Ba2VedaTransform {
	public _71e38_mnd_s_Contract(BaSystem _ba, VedaConnection _veda, Replacer replacer)  {
		super(_ba, _veda, replacer, "71e3890b3c77441bad288964bf3c3d6a", "mnd-s:Contract");
	}
	...
	public List<Individual> transform(int level, XmlDocument doc, String ba_id, String parent_veda_doc_uri,
		...
		new_individual.addProperty("v-s:customer", "d:org_RU1121014190", Type._Uri);
		...
		if ((kind_pr.equals("cc87e0778a864272b1b8d366f591da88") ||
				kind_pr.equals("fecef6b8058549cfb0203b55bd2425de"))&& irf != null) {
