...
public class _22dc2_mnd_s_Decree extends Ba2VedaTransform{
	public _22dc2_mnd_s_Decree(BaSystem _ba, VedaConnection _veda, Replacer replacer) {
		super(_ba, _veda, replacer, "22dc2b078aa14141897659d962699718", "mnd-s:Decree");
	}
	...
	public List<Individual> transform(XmlDocument doc, String ba_id, String parent_veda_doc_uri,
		...
		new_individual.addProperty("mnd-s:hasDecreeKind", new Resource("d:586ab1e3ea554a92ab6ebb64d2df8c41", Type._Uri));
		...
		if (drtr != null) {
			...
			drtr.addProperty("mnd-s:hasDecreeKind", new Resource("d:586ab1e3ea554a92ab6ebb64d2df8c41", Type._Uri));
