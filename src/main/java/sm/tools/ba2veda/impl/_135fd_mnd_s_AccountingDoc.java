...
public class _135fd_mnd_s_AccountingDoc extends Ba2VedaTransform {
	public _135fd_mnd_s_AccountingDoc(BaSystem _ba, VedaConnection _veda, Replacer replacer)  {
		super(_ba, _veda, replacer, "135fd4dbef534220b79f007d7af403f2", "mnd-s:AccountingDoc");
	}
	...
	public List<Individual> transform(int level, XmlDocument doc, String ba_id, String parent_veda_doc_uri,
		...
		new_individual.addProperty("v-s:customer", "d:org_RU1121012059", Type._Uri);
