			...
			throws Exception
	{
		...
		for (XmlAttribute att : atts)
		{
			...
			if (code.equals("№"))
				...
				checkedDepartment = ba_field_to_veda(att, uri, ba_id, doc, path, parent_ba_doc_id, parent_veda_doc_uri, true);
			else if (code.equals("Дата"))
				dateFact = ba_field_to_veda(att, uri, ba_id, doc, path, parent_ba_doc_id, parent_veda_doc_uri, true);
			else if (code.equals("contractor"))
				checkedOrganization = ba_field_to_veda(att, uri, ba_id, doc, path, parent_ba_doc_id, parent_veda_doc_uri, true);
