...
public class _df968_mnd_s_Decree extends Ba2VedaTransform{
	public _df968_mnd_s_Decree(BaSystem _ba, VedaConnection _veda, Replacer replacer) {
		super(_ba, _veda, replacer, "df9685f184f54e6fbcc683bced32cc30", "mnd-s:Decree");
	}
