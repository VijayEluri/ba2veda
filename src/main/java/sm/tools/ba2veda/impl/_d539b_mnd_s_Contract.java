...
public class _d539b_mnd_s_Contract extends Ba2VedaTransform {
	public _d539b_mnd_s_Contract(BaSystem _ba, VedaConnection _veda, Replacer replacer)  {
		super(_ba, _veda, replacer, "d539b253cb6247a381fb51f4ee34b9d8", "mnd-s:Contract");
	}
