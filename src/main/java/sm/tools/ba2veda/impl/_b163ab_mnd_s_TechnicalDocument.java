				...
				if (code.equals("Раздел")) {
					...
					if (recordId != null) {
						...
						if (recordId.equals("69ca82170be24d41b32fc9033a2574f5"))
							...
							new_individual.addProperty("v-s:hasDocumentKind", new Resource("d:kqyyu62f90hy89wh188664bxwl", Type._Uri));
							...
							new_individual.addProperty("v-s:hasDocumentKind", new Resource("d:afc1a827f2ac47a9bd19b6db910dfc13", Type._Uri));
							new_individual.addProperty("mnd-s:hasMarkOfTechnicalDocuments", new Resource("d:6ba70b2261d4443e98d91452565d3b98", Type._Uri));
						} else if (recordId.equals("584e7ef299b14bec89c516b311472ba5")) {
							new_individual.addProperty("v-s:hasDocumentKind", new Resource("d:99d3887ae22d439c9fe77a10ff5a4b0d", Type._Uri));
							new_individual.addProperty("mnd-s:hasMarkOfTechnicalDocuments", new Resource("d:6ba70b2261d4443e98d91452565d3b98", Type._Uri));
						} else if (recordId.equals("41b925655c8a44a8b34ab3b1894bebd0")) {
							new_individual.addProperty("v-s:hasDocumentKind", new Resource("d:41b925655c8a44a8b34ab3b1894bebd0", Type._Uri));
