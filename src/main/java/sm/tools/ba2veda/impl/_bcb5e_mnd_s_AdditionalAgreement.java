...
public class _bcb5e_mnd_s_AdditionalAgreement extends _xxxxx_x_Contract
{
	public _bcb5e_mnd_s_AdditionalAgreement(BaSystem _ba, VedaConnection _veda, Replacer replacer)
	{
		super(_ba, _veda, replacer, "bcb5e90806aa4f6e878b1cf0b4fdd4ab", "mnd-s:AdditionalAgreement");
			...
			throws Exception
	{
		...
		if (kind_pr != null && (kind_pr.equals(kpr1) || kind_pr.equals(kpr2)))
		{
			...
			// if (inherit_rights_from == null || inherit_rights_from.length() == 0)
			{
				...
				{
					// new_individual.addProperty("v-s:customer", new Resource("d:org_RU1121003135",
					// Type._Uri));
			...
			// transform1(doc, new_individual, kind_pr, ba_id, parent_veda_doc_uri,
			// parent_ba_doc_id, path);
			// if (new_individual.getUri() != null)
			// {
			// res.add(new_individual);
			// }
			// } else
			// {
			// System.out.println("ERR! NOT UPDATE [" + "d:" + inherit_rights_from + "], IS NOT
			// EXIST");
			// }
			// }
		}
