...
public class _fcb4a_mnd_s_Decree extends Ba2VedaTransform{
	public _fcb4a_mnd_s_Decree(BaSystem _ba, VedaConnection _veda, Replacer replacer) {
		super(_ba, _veda, replacer, "fcb4a3a1ae254a50b72613c2ee56c34e", "mnd-s:Decree");
	}
