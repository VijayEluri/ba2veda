...
public class _3b538_mnd_s_Decree extends Ba2VedaTransform {
	public _3b538_mnd_s_Decree(BaSystem _ba, VedaConnection _veda, Replacer replacer) {
		super(_ba, _veda, replacer, "3b5381d7259041108d7b3d1e251013d9", "mnd-s:Decree");
	}
