...
public class _65875_mnd_s_Decree extends Ba2VedaTransform{
	public _65875_mnd_s_Decree(BaSystem _ba, VedaConnection _veda, Replacer replacer) {
		super(_ba, _veda, replacer, "6587517cd37a438081e5574fe7029d05", "mnd-s:Decree");
	}
	...
	{
		long fixed = new SimpleDateFormat("dd.MM.yyyy").parse("07.04.2009").getTime();
		if (time >= fixed)
			return false;
	...
	public List<Individual> transform(int level, XmlDocument doc, String ba_id, String parent_veda_doc_uri,
		...
		new_individual.addProperty("mnd-s:hasDecreeKind", new Resource("d:391362e32a2b48199ef4bebe9b7a611a", Type._Uri));
		...
		if (drtr != null) {
			...
			drtr.addProperty("mnd-s:hasDecreeKind", new Resource("d:391362e32a2b48199ef4bebe9b7a611a", Type._Uri));
