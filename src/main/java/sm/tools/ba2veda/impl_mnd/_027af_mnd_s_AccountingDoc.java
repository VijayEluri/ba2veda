...
public class _027af_mnd_s_AccountingDoc extends Ba2VedaTransform
{
	public _027af_mnd_s_AccountingDoc(BaSystem _ba, VedaConnection _veda, Replacer replacer)
	{
		super(_ba, _veda, replacer, "027afafd4c444d96913422ee669e6d44", "mnd-s:AccountingDoc");
	}
	...
	public void inital_set()
	{
		...
		// default_values_map.put("v-s:backwardProperty", new Resource("v-s:hasAccountingDoc", Type._Uri));
			...
			throws Exception
	{
		...
		Resources hasDocumentKind = null;
		Resources registrationNumber = null;
		Resources registrationNumberIn = null;
		Resources registrationDate = null;
		...
		for (XmlAttribute att : atts)
		{
			...
			if (predicate != null)
			{
				...
				if (code.equals("kind_p"))
					hasDocumentKind = rss;
				else if (code.equals("number_add_p"))
					registrationNumber = rss;
				else if (code.equals("number_p"))
					registrationNumberIn = rss;
				else if (code.equals("date_add_p"))
					registrationDate = rss;
