...
public class _f577_stg_Claim extends Ba2VedaTransform
{
			...
			throws Exception
	{
		...
		for (XmlAttribute att : atts)
		{
			...
			if (predicate != null)
			{
				...
				} else if (code.equals("attachment"))
				{
					...
					crep1.addProperty("v-s:attachment", rss);
					crep1.addProperty("v-s:attachment", rss);
		...
		correspondent_organization.addProperty("v-s:correspondentOrganization", new Resource("d:org_RU1121016110_1", Type._Uri));
		...
		if (organization2 != null)
		{
			...
			correspondent_organization2.addProperty("v-s:correspondentOrganization", new Resource(org_uri, Type._Uri));
