...
7. из индивида в поле contractor берем поле inn - по нему выполняем в OF поиск по всем индивидам класса v-s:Organization - находим тот у которого поле v-s:taxId совпадает. 
Вписываем в поле v-s:hasOrganization
...
public class _496e3_v_s_ContractParticipantCustomer extends Ba2VedaTransform
{
	public _496e3_v_s_ContractParticipantCustomer(BaSystem _ba, VedaConnection _veda, Replacer replacer)
	{
		super(_ba, _veda, replacer, "496e359316334e47b87af4576d36d27c", "v-s:ContractParticipantCustomer");
	}
			...
			throws Exception
	{
		...
		} else
		{
			...
			if (id_1c != null && id_1c.indexOf("СПоставщиком") == 0)
			{
				if (owner == null || owner.equals("53343a30-449b-4e71-9103-2fcd4bdaafd1"))
					new_individual.setProperty("v-s:hasOrganization", new Resource("d:org_RU1121016110_1", Type._Uri));
